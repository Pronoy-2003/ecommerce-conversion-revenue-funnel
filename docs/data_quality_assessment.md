...
Therefore, raw event counts will **not** be used directly to calculate funnel conversion rates. User-level funnel logic will be developed on next phases.
...
The appropriate treatment of these values will be finalized during cleaning and transformation.
...
These records will not be automatically deleted at this stage. They will be investigated further before performing price-based analysis.
...
A more robust duplicate validation will therefore be performed during cleaning.
...
The complete price distribution will be analyzed before creating price bands.
...
Duplicate handling will be finalized after a stronger validation.
...
Next phases will focus on data cleaning, validation, transformation, and construction of the user-level funnel dataset.
